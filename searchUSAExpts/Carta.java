...
public class Carta {
  ...
  /**
   * addEst adds an est to a map
   * 
   * @param c1 city 1
   * @param c2 city 2
   * @param c  estimates cost
   */
  public void addEst(String c1, String c2, int c) {
    MapLink ml = new MapLink(c1, c2, c);
    ests.add(ml);
  }
  ...
  /**
   * getEsts returns all ests to/from a given city
   * 
   * @param city - the city
   * @return ArrayList of links
   */
  public ArrayList<MapLink> getEsts(String city) {
    ArrayList<MapLink> clinks = new ArrayList<MapLink>();
  ...
  public int estbetween(String c1, String c2) {
    ...
    while (i.hasNext() && (ans < 0)) {
      MapLink l = (MapLink) i.next();
      if (((c1.equals(l.getCity1()) && c2.equals(l.getCity2())))
          || ((c2.equals(l.getCity1()) && c1.equals(l.getCity2())))) {
        ans = l.getCost();
      }
  ...
  public void mapFromFile(String fname) {
    ...
    try {
      ...
      while (scanner.hasNext()) {
        ...
        // System.out.print("c1 =" + c1 + "; c2 =" + c2 + "; dist= " + dist +"\n");
